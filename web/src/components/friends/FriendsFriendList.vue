    ...
    >
      ...
      <div class="flex flex-wrap gap-2">
        ...
        <button
          ...
          :class="watchlistGidSet.has(Number(friend.gid))
          ...
          :title="watchlistGidSet.has(Number(friend.gid)) ? '取消重点监控' : '重点监控：更敏感盯梢、成熟优先偷、提前60秒布控'"
          @click="emit('toggleWatchlist', friend, $event)"
        >
